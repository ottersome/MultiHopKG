...
def histogram_all_modules(
    ...
    """
    Will send send histograms about model to wandb
    Params:
        - modules: Which modules to log
        - provided_filter: If set, it will whitelist which specific tensors will be plotted
        - num_buckets: If set, it will aggregate child tensors under its parent filter name.
    """
