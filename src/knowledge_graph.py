...
class QnAKnowledgeGraph(nn.Module):
    """
    The discrete knowledge graph is stored with an adjacency list.
    """
    def __init__(self, args):
        super(QnAKnowledgeGraph, self).__init__()
        ...
        self._load_graph_data(args.data_dir)
        self._load_all_answers(args.data_dir)
    ...
    def _load_graph_data(self, data_dir):
        # Load indices
        ...
        # Well we can start here loading a 
    ...
    def _load_all_answers(self, data_dir, add_reversed_edges=False):
